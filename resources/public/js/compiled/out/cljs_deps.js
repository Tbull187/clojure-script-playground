...
goog.addDependency("../app/state.js", ['app.state'], ['reagent.core', 'cljs.core']);
...
goog.addDependency("../components/playground/reframe.js", ['components.playground.reframe'], ['cljs.core', 're_frame.core']);
...
goog.addDependency("../components/playground/request_http/request_http_code.js", ['components.playground.request_http.request_http_code'], ['cljs.core']);
goog.addDependency("../components/playground/request_http/request_http.js", ['components.playground.request_http.request_http'], ['reagent.core', 'cljs.core', 'cljs_http.client', 'cljs.core.async', 'components.playground.request_http.request_http_code']);
goog.addDependency("../components/playground/welcome.js", ['components.playground.welcome'], ['cljs.core']);
goog.addDependency("../cljsjs/production/highlight.min.inc.js", ['highlight.js', 'cljsjs.highlight'], [], {'foreign-lib': true});
goog.addDependency("../cljsjs/production/highlight/clojure.min.inc.js", ['highlight.js.lib.languages.clojure', 'cljsjs.highlight.langs.clojure'], ['highlight.js'], {'foreign-lib': true});
goog.addDependency("../components/playground/counter/counter_code.js", ['components.playground.counter.counter_code'], ['reagent.core', 'cljs.core', 'cljsjs.highlight.langs.clojure', 'cljsjs.highlight']);
goog.addDependency("../components/playground/counter/counter.js", ['components.playground.counter.counter'], ['reagent.core', 'cljs.core', 'components.playground.counter.counter_code', 'cljsjs.highlight.langs.clojure', 'cljsjs.highlight']);
