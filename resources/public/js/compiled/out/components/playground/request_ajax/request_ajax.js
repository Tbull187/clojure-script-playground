...
goog.provide('components.playground.request_ajax.request_ajax');
goog.require('cljs.core');
goog.require('ajax.core');
goog.require('reagent.core');
goog.require('components.playground.request_ajax.request_ajax_code');
if((typeof components !== 'undefined') && (typeof components.playground !== 'undefined') && (typeof components.playground.request_ajax !== 'undefined') && (typeof components.playground.request_ajax.request_ajax !== 'undefined') && (typeof components.playground.request_ajax.request_ajax.github_users !== 'undefined')){
} else {
components.playground.request_ajax.request_ajax.github_users = reagent.core.atom.call(null,cljs.core.List.EMPTY);
}
if((typeof components !== 'undefined') && (typeof components.playground !== 'undefined') && (typeof components.playground.request_ajax !== 'undefined') && (typeof components.playground.request_ajax.request_ajax !== 'undefined') && (typeof components.playground.request_ajax.request_ajax.loading !== 'undefined')){
} else {
components.playground.request_ajax.request_ajax.loading = reagent.core.atom.call(null,false);
}
if((typeof components !== 'undefined') && (typeof components.playground !== 'undefined') && (typeof components.playground.request_ajax !== 'undefined') && (typeof components.playground.request_ajax.request_ajax !== 'undefined') && (typeof components.playground.request_ajax.request_ajax.show_code !== 'undefined')){
} else {
...
return components.playground.request_ajax.request_ajax.fetch_data.call(null);
...
return cljs.core.reset_BANG_.call(null,components.playground.request_ajax.request_ajax.show_code,cljs.core.not.call(null,cljs.core.deref.call(null,components.playground.request_ajax.request_ajax.show_code)));
