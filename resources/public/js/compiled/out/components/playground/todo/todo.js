...
components.playground.todo.todo.add_todo = (function components$playground$todo$todo$add_todo(todo_text){
console.log("Adding Todo Item with text:",todo_text);

return cljs.core.swap_BANG_.call(null,components.playground.todo.todo.todos,cljs.core.conj,todo_text);
});
components.playground.todo.todo.delete_todo = (function components$playground$todo$todo$delete_todo(todo_text){
...
components.playground.todo.todo.todo_elem = (function components$playground$todo$todo$todo_elem(text){
return (function (){
...
return components.playground.todo.todo.delete_todo.call(null,text);
})], null)], null)], null);
});
});
...
return cljs.core.reset_BANG_.call(null,val,p1__28630_SHARP_.target.value);
});})(val,reset_val))
,new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),((function (val,reset_val){
return (function (p1__28631_SHARP_){
var G__28632 = p1__28631_SHARP_.key;
switch (G__28632) {
case "Enter":
components.playground.todo.todo.add_todo.call(null,cljs.core.deref.call(null,val));
...
return (function components$playground$todo$todo$todo_form_$_iter__28633(s__28634){
return (new cljs.core.LazySeq(null,((function (val,reset_val){
return (function (){
var s__28634__$1 = s__28634;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__28634__$1);
if(temp__5720__auto__){
var s__28634__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__28634__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__28634__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__28636 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__28635 = (0);
while(true){
if((i__28635 < size__4522__auto__)){
var todo = cljs.core._nth.call(null,c__4521__auto__,i__28635);
cljs.core.chunk_append.call(null,b__28636,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [components.playground.todo.todo.todo_elem,todo], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),todo], null)));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28636),components$playground$todo$todo$todo_form_$_iter__28633.call(null,cljs.core.chunk_rest.call(null,s__28634__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28636),null);
}
} else {
var todo = cljs.core.first.call(null,s__28634__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [components.playground.todo.todo.todo_elem,todo], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),todo], null)),components$playground$todo$todo$todo_form_$_iter__28633.call(null,cljs.core.rest.call(null,s__28634__$2)));
}
} else {
return null;
}
...
//# sourceMappingURL=todo.js.map?rel=1568769407662
