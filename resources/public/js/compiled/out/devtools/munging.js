...
var o27338 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27338["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27339 = temp__5718__auto____$1;
return (o27339["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26450__auto__ = f;
return (o__26450__auto__["toString"]).call(o__26450__auto__);
} else {
return "";
}
}catch (e27340){var _ = e27340;
return "";
}});
...
try{var o__26450__auto___27342 = t;
(o__26450__auto___27342["cljs$lang$ctorPrWriter"]).call(o__26450__auto___27342,t,writer);
}catch (e27341){var __27343 = e27341;
}
...
var char_code = (function (){var o__26450__auto__ = (new String(char$));
return (o__26450__auto__["charCodeAt"]).call(o__26450__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26450__auto__ = String;
return (o__26450__auto__["fromCharCode"]).call(o__26450__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27344 = num_code;
switch (G__27344) {
case (1):
return (185);
...
var o__26450__auto__ = String;
return (o__26450__auto__["fromCharCode"]).call(o__26450__auto__,superscript_code);
});
/**
...
}catch (e27346){var _e__26457__auto__ = e27346;
return false;
}})())){
...
var vec__27347 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27347,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27350 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27350["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27351 = temp__5718__auto____$1;
return (o27351["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___27358 = arguments.length;
var i__4731__auto___27359 = (0);
while(true){
if((i__4731__auto___27359 < len__4730__auto___27358)){
args__4736__auto__.push((arguments[i__4731__auto___27359]));

var G__27360 = (i__4731__auto___27359 + (1));
i__4731__auto___27359 = G__27360;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27354){
var vec__27355 = p__27354;
var ns_detector = cljs.core.nth.call(null,vec__27355,(0),null);
...
var G__27361 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27362 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27361;
remaining_tokens = G__27362;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27352){
var G__27353 = cljs.core.first.call(null,seq27352);
var seq27352__$1 = cljs.core.next.call(null,seq27352);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27353,seq27352__$1);
});
...
var vec__27366 = cljs.core.split_with.call(null,(function (p1__27365_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27365_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27366,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27366,(1),null);
...
var vec__27372 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27372,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27372,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27375 = cljs.core.rest.call(null,remaining_tokens);
var G__27376 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27375;
name_tokens = G__27376;
continue;
} else {
...
var vec__27379 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27379,(0),null);
var arity = cljs.core.nth.call(null,vec__27379,(1),null);
var vec__27382 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27382,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27382,(1),null);
var vec__27385 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27385,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27385,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27385,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27385,(3),null);
...
var vec__27391 = result;
var munged_ns = cljs.core.nth.call(null,vec__27391,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27391,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27391,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27391,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27391,(4),null);
var arity = cljs.core.nth.call(null,vec__27391,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27395 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__27395,(0),null);
var args = cljs.core.nth.call(null,vec__27395,(1),null);
var vec__27398 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27398,(0),null);
var name = cljs.core.nth.call(null,vec__27398,(1),null);
...
var G__27401 = (arity + (1));
var G__27402 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27403){
var vec__27404 = p__27403;
var arity = cljs.core.nth.call(null,vec__27404,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27404,(1),null);
...
return cljs.core.get.call(null,arities,p1__27407_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27408_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27411){
var vec__27412 = p__27411;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27412,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27409){
var G__27410 = cljs.core.first.call(null,seq27409);
var seq27409__$1 = cljs.core.next.call(null,seq27409);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27410,seq27409__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27420__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27420__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27420__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27420__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27421 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27421,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27421,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27421,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27421,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27421,(4),null);
var arity = cljs.core.nth.call(null,vec__27421,(5),null);
...
var o__26450__auto__ = f;
return (o__26450__auto__["getBasis"]).call(o__26450__auto__);
});
/**
...
}catch (e27425){var _e__26457__auto__ = e27425;
...
var G__27426 = (obj[cljs.core.first.call(null,path)]);
var G__27427 = cljs.core.rest.call(null,path);
obj = G__27426;
path = G__27427;
continue;
} else {
...
return (function (accum,p__27428){
var vec__27429 = p__27428;
var bit = cljs.core.nth.call(null,vec__27429,(0),null);
var protocol = cljs.core.nth.call(null,vec__27429,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27432){
var vec__27433 = p__27432;
var ns = cljs.core.nth.call(null,vec__27433,(0),null);
var name = cljs.core.nth.call(null,vec__27433,(1),null);
var selector = cljs.core.nth.call(null,vec__27433,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27438,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27438,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27438,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27436_SHARP_){
return (obj[cljs.core.first.call(null,p1__27436_SHARP_)]);
});})(name,sorted_matches,vec__27438,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1567734175773
