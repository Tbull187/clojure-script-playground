...
var o47770 = temp__5718__auto__;
var temp__5718__auto____$1 = (o47770["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o47771 = temp__5718__auto____$1;
return (o47771["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__33193__auto__ = f;
return (o__33193__auto__["toString"]).call(o__33193__auto__);
} else {
return "";
}
}catch (e47772){var _ = e47772;
return "";
}});
...
try{var o__33193__auto___47774 = t;
(o__33193__auto___47774["cljs$lang$ctorPrWriter"]).call(o__33193__auto___47774,t,writer);
}catch (e47773){var __47775 = e47773;
}
...
var char_code = (function (){var o__33193__auto__ = (new String(char$));
return (o__33193__auto__["charCodeAt"]).call(o__33193__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__33193__auto__ = String;
return (o__33193__auto__["fromCharCode"]).call(o__33193__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__47776 = num_code;
switch (G__47776) {
case (1):
return (185);
...
var o__33193__auto__ = String;
return (o__33193__auto__["fromCharCode"]).call(o__33193__auto__,superscript_code);
});
/**
...
}catch (e47778){var _e__33200__auto__ = e47778;
return false;
}})())){
...
var vec__47779 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__47779,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o47782 = temp__5718__auto__;
var temp__5718__auto____$1 = (o47782["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o47783 = temp__5718__auto____$1;
return (o47783["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__47786){
var vec__47787 = p__47786;
var ns_detector = cljs.core.nth.call(null,vec__47787,(0),null);
...
var G__47793 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__47794 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__47793;
remaining_tokens = G__47794;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq47784){
var G__47785 = cljs.core.first.call(null,seq47784);
var seq47784__$1 = cljs.core.next.call(null,seq47784);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47785,seq47784__$1);
});
...
var vec__47798 = cljs.core.split_with.call(null,(function (p1__47797_SHARP_){
return cljs.core.not_EQ_.call(null,p1__47797_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__47798,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__47798,(1),null);
...
var vec__47804 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__47804,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__47804,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__47807 = cljs.core.rest.call(null,remaining_tokens);
var G__47808 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__47807;
name_tokens = G__47808;
continue;
} else {
...
var vec__47811 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__47811,(0),null);
var arity = cljs.core.nth.call(null,vec__47811,(1),null);
var vec__47814 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__47814,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__47814,(1),null);
var vec__47817 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__47817,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__47817,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__47817,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__47817,(3),null);
...
var vec__47823 = result;
var munged_ns = cljs.core.nth.call(null,vec__47823,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__47823,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__47823,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__47823,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__47823,(4),null);
var arity = cljs.core.nth.call(null,vec__47823,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__47827 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__47827,(0),null);
var args = cljs.core.nth.call(null,vec__47827,(1),null);
var vec__47830 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__47830,(0),null);
var name = cljs.core.nth.call(null,vec__47830,(1),null);
...
var G__47833 = (arity + (1));
var G__47834 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__47835){
var vec__47836 = p__47835;
var arity = cljs.core.nth.call(null,vec__47836,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__47836,(1),null);
...
return (function (p1__47839_SHARP_){
return cljs.core.get.call(null,arities,p1__47839_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__47840_SHARP_);
...
var G__47849 = (i__4731__auto___47848 + (1));
i__4731__auto___47848 = G__47849;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__47843){
var vec__47844 = p__47843;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__47844,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq47841){
var G__47842 = cljs.core.first.call(null,seq47841);
var seq47841__$1 = cljs.core.next.call(null,seq47841);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47842,seq47841__$1);
});
...
var map__47852 = options;
var map__47852__$1 = (((((!((map__47852 == null))))?(((((map__47852.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47852.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__47852):map__47852);
var include_ns_QMARK_ = cljs.core.get.call(null,map__47852__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__47852__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__47852__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__47852__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__47853 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__47853,(0),null);
var fn_name = cljs.core.nth.call(null,vec__47853,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__47853,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__47853,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__47853,(4),null);
var arity = cljs.core.nth.call(null,vec__47853,(5),null);
...
var o__33193__auto__ = f;
return (o__33193__auto__["getBasis"]).call(o__33193__auto__);
});
/**
...
}catch (e47857){var _e__33200__auto__ = e47857;
...
var G__47858 = (obj[cljs.core.first.call(null,path)]);
var G__47859 = cljs.core.rest.call(null,path);
obj = G__47858;
path = G__47859;
continue;
} else {
...
return (function (accum,p__47860){
var vec__47861 = p__47860;
var bit = cljs.core.nth.call(null,vec__47861,(0),null);
var protocol = cljs.core.nth.call(null,vec__47861,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__47864){
var vec__47865 = p__47864;
var ns = cljs.core.nth.call(null,vec__47865,(0),null);
var name = cljs.core.nth.call(null,vec__47865,(1),null);
var selector = cljs.core.nth.call(null,vec__47865,(2),null);
...
return (function (p__47869){
var vec__47870 = p__47869;
var munged_name = cljs.core.nth.call(null,vec__47870,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__47870,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__47870,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__47868_SHARP_){
return (obj[cljs.core.first.call(null,p1__47868_SHARP_)]);
});})(name,sorted_matches,vec__47870,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1569211513168
