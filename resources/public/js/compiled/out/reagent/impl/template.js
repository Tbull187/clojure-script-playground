...
var G__39241 = o;
(G__39241[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__39245 = o;
(G__39245[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__39250 = props;
var G__39250__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__39250,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39250);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__39250__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__39251){
...
var props = map__39252__$1;
var class$ = cljs.core.get.call(null,map__39252__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__39252,map__39252__$1,props,class$){
return (function (c){
...
});})(map__39252,map__39252__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__39254){
...
var on_write = cljs.core.get.call(null,map__39255__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__39255,map__39255__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__39255,map__39255__$1,on_write))
);
} else {
...
var G__39258 = jsprops;
(G__39258["defaultValue"] = value);

(G__39258["onChange"] = ((function (G__39258,v,value,on_change){
return (function (p1__39257_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__39257_SHARP_);
});})(G__39258,v,value,on_change))
);
...
var vec__39261 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__39261,(0),null);
var id = cljs.core.nth.call(null,vec__39261,(1),null);
var class$ = cljs.core.nth.call(null,vec__39261,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___39265 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___39265 == null)){
} else {
var key_39266 = temp__5724__auto___39265;
(jsprops["key"] = key_39266);
}
...
var temp__5724__auto___39267 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___39267 == null)){
} else {
var key_39268 = temp__5724__auto___39267;
reagent.impl.template.oset.call(null,jsprops,"key",key_39268);
}
...
var G__39269 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__39269["name"] = c);
...
var len__4730__auto___39275 = arguments.length;
var i__4731__auto___39276 = (0);
while(true){
if((i__4731__auto___39276 < len__4730__auto___39275)){
args__4736__auto__.push((arguments[i__4731__auto___39276]));

var G__39277 = (i__4731__auto___39276 + (1));
i__4731__auto___39276 = G__39277;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq39273){
var G__39274 = cljs.core.first.call(null,seq39273);
var seq39273__$1 = cljs.core.next.call(null,seq39273);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39274,seq39273__$1);
});
...
break;
default:
var G__39280 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__39280;
continue;
...
var n__4607__auto___39282 = a.length;
var i_39283 = (0);
while(true){
if((i_39283 < n__4607__auto___39282)){
(a[i_39283] = reagent.impl.template.as_element.call(null,(a[i_39283])));

var G__39284 = (i_39283 + (1));
i_39283 = G__39284;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___39285 = a.length;
var i_39286 = (0);
while(true){
if((i_39286 < n__4607__auto___39285)){
var val_39287 = (a[i_39286]);
if(((cljs.core.vector_QMARK_.call(null,val_39287)) && ((reagent.impl.template.key_from_vec.call(null,val_39287) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_39286] = reagent.impl.template.as_element.call(null,val_39287));

var G__39288 = (i_39286 + (1));
i_39286 = G__39288;
continue;
} else {
}
...
var ctx = ({});
var vec__39289 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__39289,(0),null);
var derefed = cljs.core.nth.call(null,vec__39289,(1),null);
...
var G__39292 = (cljs.core.count.call(null,argv) - first_child);
switch (G__39292) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__39292){
...
//# sourceMappingURL=template.js.map?rel=1569211503207
