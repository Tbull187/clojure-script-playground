...
var G__21781 = o;
(G__21781[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21785 = o;
(G__21785[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__21786__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__21787__i < G__21787__a.length) {G__21787__a[G__21787__i] = arguments[G__21787__i + 0]; ++G__21787__i;}
  args = new cljs.core.IndexedSeq(G__21787__a,0,null);
} 
return G__21786__delegate.call(this,args);};
G__21786.cljs$lang$maxFixedArity = 0;
G__21786.cljs$lang$applyTo = (function (arglist__21788){
var args = cljs.core.seq(arglist__21788);
return G__21786__delegate(args);
});
...
var G__21790 = props;
var G__21790__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21790,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21790);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21790__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__21791){
...
var props = map__21792__$1;
var class$ = cljs.core.get.call(null,map__21792__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__21792,map__21792__$1,props,class$){
return (function (c){
...
});})(map__21792,map__21792__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__21794){
...
var on_write = cljs.core.get.call(null,map__21795__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__21795,map__21795__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__21795,map__21795__$1,on_write))
);
} else {
...
var G__21798 = jsprops;
(G__21798["defaultValue"] = value);

(G__21798["onChange"] = ((function (G__21798,v,value,on_change){
return (function (p1__21797_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21797_SHARP_);
});})(G__21798,v,value,on_change))
);
...
var vec__21801 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21801,(0),null);
var id = cljs.core.nth.call(null,vec__21801,(1),null);
var class$ = cljs.core.nth.call(null,vec__21801,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___21805 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___21805 == null)){
} else {
var key_21806 = temp__5724__auto___21805;
...
var temp__5724__auto___21807 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___21807 == null)){
} else {
var key_21808 = temp__5724__auto___21807;
reagent.impl.template.oset.call(null,jsprops,"key",key_21808);
}
...
var G__21809 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__21809["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21813){
var G__21814 = cljs.core.first.call(null,seq21813);
var seq21813__$1 = cljs.core.next.call(null,seq21813);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21814,seq21813__$1);
});
...
break;
default:
var G__21820 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__21820;
continue;
...
var n__4607__auto___21822 = a.length;
var i_21823 = (0);
while(true){
if((i_21823 < n__4607__auto___21822)){
(a[i_21823] = reagent.impl.template.as_element.call(null,(a[i_21823])));

var G__21824 = (i_21823 + (1));
i_21823 = G__21824;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___21825 = a.length;
var i_21826 = (0);
while(true){
if((i_21826 < n__4607__auto___21825)){
var val_21827 = (a[i_21826]);
if(((cljs.core.vector_QMARK_.call(null,val_21827)) && ((reagent.impl.template.key_from_vec.call(null,val_21827) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_21826] = reagent.impl.template.as_element.call(null,val_21827));
...
var ctx = ({});
var vec__21829 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21829,(0),null);
var derefed = cljs.core.nth.call(null,vec__21829,(1),null);
...
var G__21832 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21832) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__21832){
...
//# sourceMappingURL=template.js.map?rel=1567734171803
